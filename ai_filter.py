...
EXCLUDE_KEYWORDS = [
    ...
    "세계기록유산", "인류무형유산", "상해보험", "달력", "정수기", "자동차보험", "가족캠프", "운동장", "교량", "안테나", "여행자보험", "전자공", "광고물", "대관 용역" ,"비탈면", "CODA"
]
_EXCLUDE_PATTERN = re.compile("|".join(map(re.escape, EXCLUDE_KEYWORDS)))

# 2. 핵심 ODA 키워드 (무조건 합격)
CORE_KEYWORDS = [
    "ODA", "공적개발원조", "KOICA", "EDCF", "수출입은행",  "개발협력", "국제협력", "성과관리", "종료평가", "PMC", "형성조사",
    "대외경제협력기금", "국제개발협력", "수원국", "무상원조", "한국국제보건의료재단", "KOFIH", "국제질병퇴치기금", 
    "다자개발은행", "MDB", "글로벌녹색성장기구", "GGGI", "경제발전경험공유사업", "KSP", "경제혁신파트너십프로그램", "EIPP", 
    "월드프렌즈코리아", "WFK", "글로벌 연수사업", "PMC 용역", "형성조사", "기획조사", "예비조사", "초청연수", "초청 연수", "기아대책",     
    # 다자개발은행 (MDB)
    ...
    # 국가
    "중저소득국", "LMIC", "하위중소득국", "최빈국", "최빈개발도상국", "LMICs", "군소도서개도국", "SIDS", "내륙개도국", "LLDC", "LLDCs", "취약국", "분쟁취약국", "FCV", "글로벌 사우스", "글로벌사우스", "LDC", "LDCs", "중고소득국", "상위중소득국"
]
...
AMBIGUOUS_KEYWORDS = [
    # 💡 ODA 실무 키워드 및 대륙명
   "기술협력", "개발지원", "조성사업", "강화사업", "구축사업", 
    "역량강화", "역량 강화", "마스터플랜", "타당성조사", "타당성 조사", "심층조사", "심층 조사", "기획조사", "기획 조사", "영향평가", "중간평가",
