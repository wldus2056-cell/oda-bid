...
AMBIGUOUS_KEYWORDS = [
    # 💡 ODA 실무 키워드 및 대륙명
    "개발협력", "국제협력", "기술협력", "개발지원", "조성사업", "강화사업", "구축사업", "PMC"
